...
use App\Http\Controllers\Admin\VelipayPaymentsController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth:admin', 'admin.verified'])->group(function () {
        ...
        Route::get('velipay-payments', [VelipayPaymentsController::class, 'index'])->name('velipay-payments.index');
        Route::get('velipay-payments/{velipayPayment}', [VelipayPaymentsController::class, 'show'])->name('velipay-payments.show');
