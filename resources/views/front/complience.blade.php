...
<div class="container my-5">
    <br><h3><strong>Compliance</strong></h3>
    <p>
    ...
    <ul>
        ...
        <li>
            <strong>Payment Compliance:</strong><br>
            All payments on the platform are processed exclusively through authorized mobile money services such as <strong>M-Pesa</strong>. We adhere to Anti-Money Laundering (AML) and Know Your Customer (KYC) standards where applicable, to prevent fraudulent and illicit transactions.
        </li>
        ...
        <li>
            <strong>Audit and Record-Keeping:</strong><br>
        ...
        <li>
            <strong>Cooperation with Authorities:</strong><br>
