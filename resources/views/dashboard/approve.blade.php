    ...
    <div class="container py-5">
        ...
        <div id="transaction-details-card" style="display: none; transition: max-height 0.5s cubic-bezier(0.4,0,0.2,1), opacity 0.5s; overflow: hidden; max-height: 0; opacity: 0;">
            <div class="card mx-auto mb-4" style="max-width: 600px;">
                ...
                <div class="card-body">
                    <div class="mb-2"><strong>ID:</strong> {{ $transaction->id ?? 'N/A' }}</div>
                    <div class="mb-2"><strong>Type:</strong> {{ $transaction->type ?? '-' }}</div>
                    ...
                    <div class="mb-2"><strong>Amount:</strong> KES {{ number_format($transaction->amount ?? 0, 2) }}</div>
                    ...
                    <div class="mb-2"><strong>Details:</strong> {{ $transaction->details ?? '-' }}</div>
